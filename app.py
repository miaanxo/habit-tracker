...
# Keyless cat photo API (Cataas)
CATAAS_RANDOM_JSON = "https://cataas.com/cat?json=true"

LOCAL_CAT_FACTS_KO = [
    "고양이는 사람에게만 특별히 '야옹'을 쓰는 경우가 많다. 인간 전용 음성 패치 느낌이다.",
    "고양이는 하루의 큰 비율을 잠으로 보낸다. 그건 게으름이 아니라 고양이의 기본 스펙이다.",
    "고양이의 꼬리는 기분의 안테나처럼 움직이지만, 해석은 늘 본인 마음이다.",
    "고양이는 박스를 보면 들어가야 한다. 이유는 없다. 그게 규칙이다(고양이 기준).",
    "고양이는 창밖을 보는 것으로 시간을 녹일 수 있다. 그게 계획이다.",
    "고양이는 천천히 눈을 깜빡이면 대체로 호의적인 신호로 여겨진다.",
    "고양이는 수염으로 공간 감각을 잡는다고 알려져 있다. 안테나 장착형 생물.",
    "고양이는 높은 곳을 좋아하는 경우가 많다. 세상을 내려다보면 기분이 좋아진다(고양이 기준).",
    "고양이는 간식을 기억하고, 나머지는 선택적으로 기억한다는 전설이 있다.",
    "고양이는 가끔 아무것도 안 하는데도 바쁘다. 매우 바쁘다.",
    "고양이의 발바닥 젤리는 촉감이 독특하고, 귀여움 수치가 높다.",
    "고양이는 갑자기 달리기 시작할 수 있다. 특별한 이유는 종종 없다.",
]
...
CUSTOM_CARDS: List[Dict[str, Any]] = [
    {"id": "cat_major_00", "name_ko": "0. 바보 고양이", "arcana": "major", "suit": None, "keywords": ["즉흥", "우연", "허술함"], "emoji": "🐾"},
    {"id": "cat_major_01", "name_ko": "1. 마술사 고양이", "arcana": "major", "suit": None, "keywords": ["기교", "손재주", "그럴싸"], "emoji": "🪄"},
    {"id": "cat_major_02", "name_ko": "2. 여사제 고양이", "arcana": "major", "suit": None, "keywords": ["눈치", "비밀", "침묵"], "emoji": "🌙"},
    {"id": "cat_major_03", "name_ko": "3. 여황제 고양이", "arcana": "major", "suit": None, "keywords": ["포근", "풍요", "간식"], "emoji": "🧁"},
    {"id": "cat_major_04", "name_ko": "4. 황제 고양이", "arcana": "major", "suit": None, "keywords": ["영역", "통제", "규칙(있는 척)"], "emoji": "👑"},
    {"id": "cat_major_05", "name_ko": "5. 교황 고양이", "arcana": "major", "suit": None, "keywords": ["의식", "전통", "엄숙"], "emoji": "🕯️"},
    {"id": "cat_major_06", "name_ko": "6. 연인 고양이", "arcana": "major", "suit": None, "keywords": ["선택", "애착", "삐짐"], "emoji": "💞"},
    {"id": "cat_major_07", "name_ko": "7. 전차 고양이", "arcana": "major", "suit": None, "keywords": ["돌진", "급발진", "질주"], "emoji": "🏎️"},
    {"id": "cat_major_08", "name_ko": "8. 힘 고양이", "arcana": "major", "suit": None, "keywords": ["끈기", "발톱", "참는 척"], "emoji": "💪"},
    {"id": "cat_major_09", "name_ko": "9. 은둔자 고양이", "arcana": "major", "suit": None, "keywords": ["혼자", "조용", "관찰"], "emoji": "🕳️"},
    {"id": "cat_major_10", "name_ko": "10. 수레바퀴 고양이", "arcana": "major", "suit": None, "keywords": ["랜덤", "회전", "그냥됨"], "emoji": "🎡"},
    {"id": "cat_major_11", "name_ko": "11. 정의 고양이", "arcana": "major", "suit": None, "keywords": ["공정", "판결", "심판(같은 척)"], "emoji": "⚖️"},
    {"id": "cat_major_12", "name_ko": "12. 매달린 고양이", "arcana": "major", "suit": None, "keywords": ["역발상", "정지", "대롱"], "emoji": "🪢"},
    {"id": "cat_major_13", "name_ko": "13. 큰 변화 고양이", "arcana": "major", "suit": None, "keywords": ["리셋", "변화", "갈아엎기"], "emoji": "🌀"},
    {"id": "cat_major_14", "name_ko": "14. 절제 고양이", "arcana": "major", "suit": None, "keywords": ["적당", "균형", "눈치껏"], "emoji": "🥛"},
    {"id": "cat_major_15", "name_ko": "15. 악마 고양이", "arcana": "major", "suit": None, "keywords": ["유혹", "집착", "레이저"], "emoji": "😈"},
    {"id": "cat_major_16", "name_ko": "16. 타워 고양이", "arcana": "major", "suit": None, "keywords": ["붕괴", "깜짝", "넘어짐"], "emoji": "🧱"},
    {"id": "cat_major_17", "name_ko": "17. 별 고양이", "arcana": "major", "suit": None, "keywords": ["반짝", "기분", "괜히희망"], "emoji": "⭐"},
    {"id": "cat_major_18", "name_ko": "18. 달 고양이", "arcana": "major", "suit": None, "keywords": ["몽롱", "착각", "야행"], "emoji": "🌙"},
    {"id": "cat_major_19", "name_ko": "19. 태양 고양이", "arcana": "major", "suit": None, "keywords": ["따뜻", "광합성", "누움"], "emoji": "☀️"},
    {"id": "cat_major_20", "name_ko": "20. 심판 고양이", "arcana": "major", "suit": None, "keywords": ["재등장", "알림", "불시검문"], "emoji": "📯"},
    {"id": "cat_major_21", "name_ko": "21. 세계 고양이", "arcana": "major", "suit": None, "keywords": ["완성", "한바퀴", "끝인척"], "emoji": "🌏"},

    {"id": "cat_cups_01", "name_ko": "컵 1: 젖은 발", "arcana": "minor", "suit": "cups", "keywords": ["촉촉", "감정", "기분먼저"], "emoji": "🥛"},
    {"id": "cat_cups_02", "name_ko": "컵 2: 두 그릇", "arcana": "minor", "suit": "cups", "keywords": ["관계", "나눔", "서로봄"], "emoji": "🫶"},
    {"id": "cat_cups_03", "name_ko": "컵 3: 물그릇 파티", "arcana": "minor", "suit": "cups", "keywords": ["소동", "축하", "찰랑"], "emoji": "🎉"},
    {"id": "cat_wands_01", "name_ko": "완드 1: 레이저 점", "arcana": "minor", "suit": "wands", "keywords": ["충동", "불꽃", "쫓아감"], "emoji": "🔴"},
    {"id": "cat_wands_02", "name_ko": "완드 2: 창가 정찰", "arcana": "minor", "suit": "wands", "keywords": ["정찰", "계획", "밖궁금"], "emoji": "🪟"},
    {"id": "cat_wands_03", "name_ko": "완드 3: 캣워크", "arcana": "minor", "suit": "wands", "keywords": ["진출", "확장", "영역넓힘"], "emoji": "🧗"},
    {"id": "cat_swords_01", "name_ko": "소드 1: 날선 야옹", "arcana": "minor", "suit": "swords", "keywords": ["말", "생각", "정곡"], "emoji": "🗡️"},
    {"id": "cat_swords_02", "name_ko": "소드 2: 눈감기", "arcana": "minor", "suit": "swords", "keywords": ["회피", "보류", "모른척"], "emoji": "🙈"},
    {"id": "cat_swords_03", "name_ko": "소드 3: 심장 모양 털뭉치", "arcana": "minor", "suit": "swords", "keywords": ["서운", "찔림", "털빠짐"], "emoji": "💔"},
    {"id": "cat_pents_01", "name_ko": "펜타 1: 동전 간식", "arcana": "minor", "suit": "pentacles", "keywords": ["현실", "보상", "득템"], "emoji": "🪙"},
    {"id": "cat_pents_02", "name_ko": "펜타 2: 저글링 장난감", "arcana": "minor", "suit": "pentacles", "keywords": ["멀티", "균형", "양손냥"], "emoji": "🤹"},
    {"id": "cat_pents_03", "name_ko": "펜타 3: 박스 공사", "arcana": "minor", "suit": "pentacles", "keywords": ["구조", "협업", "리모델링"], "emoji": "📦"},

    {"id": "cat_odd_01", "name_ko": "이상한 카드: 박스", "arcana": "odd", "suit": None, "keywords": ["숨기", "넣기", "편함"], "emoji": "📦"},
    {"id": "cat_odd_02", "name_ko": "이상한 카드: 새벽 우다다", "arcana": "odd", "suit": None, "keywords": ["폭주", "새벽", "질주"], "emoji": "💨"},
    {"id": "cat_odd_03", "name_ko": "이상한 카드: 정체불명 부스러기", "arcana": "odd", "suit": None, "keywords": ["발견", "의문", "먹말"], "emoji": "🧩"},
    {"id": "cat_odd_04", "name_ko": "이상한 카드: 비닐봉지", "arcana": "odd", "suit": None, "keywords": ["바스락", "유혹", "금지소리"], "emoji": "🛍️"},
    {"id": "cat_odd_05", "name_ko": "이상한 카드: 벽의 그림자", "arcana": "odd", "suit": None, "keywords": ["사냥", "오해", "환상"], "emoji": "👤"},
    {"id": "cat_odd_06", "name_ko": "이상한 카드: 엎어진 물", "arcana": "odd", "suit": None, "keywords": ["사고", "흔적", "모른척"], "emoji": "💧"},
    {"id": "cat_odd_07", "name_ko": "이상한 카드: 청소기", "arcana": "odd", "suit": None, "keywords": ["위협", "도망", "소음"], "emoji": "🧹"},
    {"id": "cat_odd_08", "name_ko": "이상한 카드: 느린 눈깜빡", "arcana": "odd", "suit": None, "keywords": ["평화", "괜찮음", "친화"], "emoji": "😽"},
    {"id": "cat_odd_09", "name_ko": "이상한 카드: 발바닥 젤리", "arcana": "odd", "suit": None, "keywords": ["귀여움", "촉감", "비밀저장"], "emoji": "🫘"},
    {"id": "cat_odd_10", "name_ko": "이상한 카드: 창문 감시", "arcana": "odd", "suit": None, "keywords": ["관찰", "정찰", "시간순삭"], "emoji": "👀"},
]
...
def load_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "draw_history": [],
        "dex": {},
        "api_status": {"tarot": "—", "catfacts": "—", "catphoto": "—"},
    }
...
def ensure_today(data: Dict[str, Any]) -> None:
    ...
    if data["today"].get("date") != t:
        data["today"] = {
            ...
            "checked_in": False,
            "drawn": False,
            "reset_salt": int(data.get("today", {}).get("reset_salt", 0) or 0),
        }
    if "draw_history" not in data or not isinstance(data["draw_history"], list):
        data["draw_history"] = []
    if "dex" not in data or not isinstance(data["dex"], dict):
        data["dex"] = {}
    if "api_status" not in data or not isinstance(data["api_status"], dict):
        data["api_status"] = {"tarot": "—", "catfacts": "—", "catphoto": "—"}
...
def dex_update(
    ...
    if not entry:
        entry = {"count": 0, "first_seen": date_s, "last_seen": date_s, "notes": [], "last_image_url": None}
        dex[card_id] = entry
    ...
    if image_url:
        entry["last_image_url"] = image_url
    notes = entry.get("notes", [])
    if not isinstance(notes, list):
        notes = []
    notes.append({"date": date_s, "one_liner": one_liner, "reading": reading, "vibe_tags": vibe_tags, "image_url": image_url})
...
def fetch_cat_fact_cached() -> Tuple[Optional[str], str]:
    ...
    if ok and isinstance(obj, dict) and obj.get("fact"):
        return str(obj["fact"]).strip(), "OK(primary)"
    ok2, obj2, msg2 = http_get_json(CAT_FACTS_FALLBACK, timeout=12)
    if ok2:
        if isinstance(obj2, dict) and obj2.get("text"):
            return str(obj2["text"]).strip(), "OK(fallback)"
        if isinstance(obj2, list) and obj2 and isinstance(obj2[0], dict) and obj2[0].get("text"):
            return str(obj2[0]["text"]).strip(), "OK(fallback)"
    return None, f"FAIL: {msg} / {msg2}"

@st.cache_data(ttl=10 * 60, show_spinner=False)
def fetch_cat_photo_url_cached() -> Tuple[Optional[str], str]:
    ok, obj, msg = http_get_json(CATAAS_RANDOM_JSON, timeout=12)
    if not ok or not isinstance(obj, dict):
        return None, f"FAIL: {msg}"
    cid = obj.get("_id") or obj.get("id")
    if not cid:
        return None, "FAIL: no id"
    url = f"https://cataas.com/cat/{cid}"
    return url, "OK"

# ----------------------------
# OpenAI: JSON generation + cat fact translation
# ----------------------------
def build_openai_payload_generate(card: Dict[str, Any], cat_fact_ko: str, mode_label: Optional[str]) -> Dict[str, Any]:
    ...
    system = (
        ...
        "의료/법률/투자 조언 금지. "
        "카드의 분위기만 이야기하고, 결론은 가볍고 재미있고 약간 무책임해야 한다. "
        "출력은 반드시 JSON 하나로만."
    )
    user = (
        f"고양이 상식(한국어): {cat_fact_ko}\n\n"
        ...
        "- 고양이 상식을 '자연스럽게' 섞되, 상식 자체를 길게 설명하지 말기\n"
        "- 책임지지 않는 톤 유지\n"
    )
    return {
        "model": MODEL_NAME,
...
def build_openai_payload_translate_fact(fact_en: str) -> Dict[str, Any]:
    system = (
        "너는 번역기다. 영어 문장을 자연스러운 한국어 한 문장으로 번역하라. "
        "과장하거나 조언/평가를 추가하지 말고, 정보만 번역한다. "
        "출력은 반드시 JSON 하나로만."
    )
    user = (
        "아래 문장을 한국어로 자연스럽게 번역해. 길이는 한 문장으로 유지.\n\n"
        f"EN: {fact_en}\n\n"
        "반드시 아래 JSON 스키마로만 출력:\n"
        '{ "ko": "string" }'
    )
...
def call_openai_json(api_key: str, payload: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    if not api_key:
        return None
...
def maybe_translate_fact_to_ko(api_key: str, fact: str) -> str:
    if not fact:
        return random.choice(LOCAL_CAT_FACTS_KO)
    # naive check: if contains Hangul, assume already ko
    if any("가" <= ch <= "힣" for ch in fact):
        return fact
    # if no api key, fall back to local ko facts
    if not api_key:
        return random.choice(LOCAL_CAT_FACTS_KO)
    payload = build_openai_payload_translate_fact(fact)
    data = call_openai_json(api_key, payload)
    if not data or "ko" not in data:
        return random.choice(LOCAL_CAT_FACTS_KO)
...
def generate_reading(api_key: str, card: Dict[str, Any], cat_fact_ko: str, mode_label: Optional[str]) -> Dict[str, Any]:
    payload = build_openai_payload_generate(card, cat_fact_ko, mode_label)
    data = call_openai_json(api_key, payload)
    if not data:
        return local_reading(card, cat_fact_ko, mode_label)
...
def local_reading(card: Dict[str, Any], cat_fact_ko: str, mode_label: Optional[str]) -> Dict[str, Any]:
    seed_src = f"{today_str()}::{card.get('id')}::{mode_label or ''}::{cat_fact_ko}"
    ...
    s2 = f"오늘의 고양이 상식은 이렇게 섞인다: {cat_fact_ko}"
    s3 = rng.choice(["딱히 결론은 없다.", "이 정도면 충분히 신비롭다.", "아무튼 분위기는 성립했다."])
...
def pick_cards(pool: List[Dict[str, Any]], mode: int, reset_salt: int) -> List[Dict[str, Any]]:
    ...
    return [rng.choice(pool) for _ in range(mode)]

def deterministic_pick_from_list(items: List[str], salt: str) -> str:
    h = hashlib.sha256(salt.encode("utf-8")).hexdigest()
    idx = int(h[:8], 16) % max(1, len(items))
    return items[idx]
...
def render_card(card: Dict[str, Any], reading: Dict[str, Any], image_url: Optional[str]) -> None:
...
st.session_state["data"]["api_status"]["tarot"] = tarot_status
...
with st.sidebar:
    ...
    st.write(f"- Tarot API: {st.session_state['data']['api_status'].get('tarot','—')}")
    st.write(f"- Cat Facts API: {st.session_state['data']['api_status'].get('catfacts','—')}")
    st.write(f"- Cat Photo API: {st.session_state['data']['api_status'].get('catphoto','—')}")

    if st.button("🐱 외부 API 테스트 호출", use_container_width=True):
        fact, fstatus = fetch_cat_fact_cached()
        st.session_state["data"]["api_status"]["catfacts"] = fstatus
        photo, pstatus = fetch_cat_photo_url_cached()
        st.session_state["data"]["api_status"]["catphoto"] = pstatus
        persist()
        if fact:
            st.success(f"Cat Fact OK: {fact[:120] + ('…' if len(fact) > 120 else '')}")
        else:
            st.warning("Cat Fact FAIL: 로컬로 대체 가능")
        if photo:
            st.success("Cat Photo OK")
            st.image(photo, use_container_width=True)
        else:
            st.warning("Cat Photo FAIL: placeholder로 대체 가능")
        ...
        with c1:
            if st.button("응, 다 날려", use_container_width=True, key="do_full_reset"):
                st.session_state["data"] = {
                    ...
                    "draw_history": [],
                    "dex": {},
                    "api_status": {"tarot": tarot_status, "catfacts": "—", "catphoto": "—"},
                }
...
with tab_draw:
    ...
    with left:
        ...
        if already:
            ...
            if d["today"].get("checked_in"):
                st.success("뽑기 가능 상태. (가벼운 의식 진행 가능)")
            else:
        ...
        note = st.text_input("메모(선택)", placeholder="오늘의 한 줄…", max_chars=140)

        can_draw = bool(d["today"].get("checked_in")) and not already
        draw_btn = st.button("🎲 뽑기", use_container_width=True, disabled=not can_draw)

        if draw_btn:
            fact_raw, fstatus = fetch_cat_fact_cached()
            d["api_status"]["catfacts"] = fstatus

            # translate or replace with KO
            if fact_raw:
                fact_ko = maybe_translate_fact_to_ko(api_key, fact_raw)
            else:
                fact_ko = random.choice(LOCAL_CAT_FACTS_KO)

            reset_salt = int(d["today"].get("reset_salt", 0))
            cards = pick_cards(COMBINED_POOL, mode=mode, reset_salt=reset_salt)

            # Labels: do NOT show the word "아무말"
            labels = None
            if mode == 3:
                labels = ["어제의 기류", "오늘의 기류", "덤 기류"]

            cards_out = []
            for i, card in enumerate(cards):
                mode_label = labels[i] if labels else None

                # Cat photo per card (keyless). If fail, keep None.
                img_url, pstatus = fetch_cat_photo_url_cached()
                d["api_status"]["catphoto"] = pstatus

                reading = generate_reading(api_key, card, fact_ko, mode_label)
                cards_out.append(
                    {
                        "id": card["id"],
                ...
                dex_update(d, card["id"], t, reading["one_liner"], reading["reading"], reading.get("vibe_tags", []), img_url)
    ...
    with right:
        ...
        if not rec:
            ...
            st.write("")
            cards_out = rec.get("cards", [])
            for cinfo in cards_out:
                ...
                card = CARD_INDEX.get(
                    ...
                    {
                        "id": cinfo["id"],
                        "name_ko": cinfo.get("name", cinfo["id"]),
                        "arcana": "odd",
                        "suit": None,
                        "keywords": [],
                        "emoji": "🐱",
                        "source": cinfo.get("source", "custom"),
                    },
                )
                reading = {"one_liner": cinfo.get("one_liner", ""), "reading": cinfo.get("reading", ""), "vibe_tags": cinfo.get("vibe_tags", [])}
                render_card(card, reading, cinfo.get("image_url"))

            fact_ko = cards_out[0].get("cat_fact_ko") if cards_out else None
            if fact_ko:
                st.divider()
                st.caption("오늘의 고양이 상식(카드에 섞였을지도 모름)")
                st.write(fact_ko)
